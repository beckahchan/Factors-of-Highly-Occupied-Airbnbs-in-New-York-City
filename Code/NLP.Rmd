...
#import data
data <- read.csv("data_nlp.csv", sep = ",", header = TRUE)
...
.csv(topwords_description_df, "description.csv", row.names=FALSE)
...
.csv(topwords_name_df, "name.csv", row.names=FALSE)
...
.csv(NER_df, "locations_df.csv", row.names=FALSE)
